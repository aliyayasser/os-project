...
public class ChatServer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextAreaChatMsg.setFont(new java.awt.Font("Arial Black", 1, 14)); // NOI18N
        jTextAreaChatMsg.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            ...
            scanner = new Scanner(socket.getInputStream()); // take data from client
            writer = new PrintWriter(socket.getOutputStream(), true); // send data to client , true : enables automatic flushing.
